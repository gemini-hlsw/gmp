...
public class ChannelAcessShort extends ChannelAccess<Short>{

    private static final Logger LOG = Logger.getLogger(ChannelAcessShort.class.getName());

    @Override
    public void connect() {
        try {
            _epicsChannel = (ReadWriteClientEpicsChannel<Short>) _ew1.getShortChannel(_caname);
    ...
    public ChannelAcessShort(String caname, EpicsWriter ew1, int type) {
